                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">You have 
                                 @if($registrations_students->contains('school_year_id', '=', $current_school_year->id))

                                      @if($registrations_students->contains('group_id', '=', $current_registration_teacher->group_id))
