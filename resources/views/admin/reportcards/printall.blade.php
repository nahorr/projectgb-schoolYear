...
<div class="page1">
        <div class="row">
            ...
            <div class="col-xs-6 ">
              ...
              @foreach($student_users->where('registration_code', '=', $student->registration_code ) as $student_user)
         ...
         <div class="col-xs-4 ">
          ...
          <ul class="list-group">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item justify-content-between">
                Overall &#37; (Total): 
                <span class="label label-primary pull-right">{{number_format(@$course_grades->where('student_id', '=', $student->id)->sum('total')/@$course_grades->where('student_id', '=', $student->id)->count()), 2}} &#37; ({{@$course_grades->where('student_id', '=', $student->id)->sum('total')}})</span>
              </li>
              @else
              <li class="list-group-item justify-content-between">
                Overall &#37;: 
         ...
         <div class="col-xs-4 ">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item justify-content-between">
                ...
                <span class="label label-primary pull-right">{{ @$attendances->where('student_id', '=', $student->id)->count() }}</span>
              </li>
              <li class="list-group-item justify-content-between">
                Times Present:
                <span class="label label-primary pull-right">{{ @$attendances->where('student_id', '=', $student->id)->where('attendance_code_id', '=', '1')->count() }}</span>
              </li>
              <li class="list-group-item justify-content-between">
                Times absent:
                <span class="label label-primary pull-right">{{ @$attendances->where('student_id', '=', $student->id)->where('attendance_code_id', '=', '2')->count() }}</span>
              </li>
              <li class="list-group-item justify-content-between">
                Times Late:
                <span class="label label-primary pull-right">{{@$attendances->where('student_id', '=', $student->id)->where('attendance_code_id', '=', '3')->count()}}</span>
              </li>
        ...
        <div class="col-xs-4">
          ...
          <ul class="list-group">
            ...
            @foreach($health_records->where('student_id', '=', $student->id) as $health_record)
              <li class="list-group-item justify-content-between">
                Student's Weight:
          ...
          <div class="col-xs-4">
            <ul class="list-group">
              ...
              <li class="list-group-item justify-content-between">
                  ...
                  @if( @$course_grades->where('student_id', '=', $student->id)->count() > 0 && ( @$course_grades->where('student_id', '=', $student->id)->sum('total')/@$course_grades->where('student_id', '=', $student->id)->count() ) >= 50 )
              ...
              <li class="list-group-item justify-content-between">
                  ...
                  @if(@$course_grades->where('student_id', '=', $student->id)->count() > 0 &&( @$course_grades->where('student_id', '=', $student->id)->sum('total')/@$course_grades->where('student_id', '=', $student->id)->count() ) >= 50 && @$term->id == 3)
        ...
        <div class="page2">
            ...
            <div class="col-xs-12">
                ...
                <div class="well well-sm">
                  ...
                  @foreach(@$comment_all->where('student_id', '=', @$student->id) as $comment)
        ...
        <div class="row"> 
                      ...
                      <div class="col-xs-4">
                        ...
                        @foreach($psychomotors->where('student_id', '=', $student->id) as $psychomotor)
                          <li class="list-group-item justify-content-between">
                            Hand Writting
                  ...
                  <div class="col-xs-4">
                    ...
                    @foreach($effective_areas->where('student_id', '=', $student->id) as $effective_area)  
                      </li>
                      <li class="list-group-item justify-content-between">
                        Punctuality
                  ...
                  <div class="col-xs-4">
                    ...
                    @foreach($learnining_accademics->where('student_id', '=', $student->id) as $learnining_accademic)    
                      </li>
                      <li class="list-group-item justify-content-between">
                        Class Work
