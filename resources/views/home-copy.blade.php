                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <p class="category"> School Year: &nbsp;&nbsp;{{ $current_school_year->school_year}}</p>
                                    </div>
                                    <br>
                                    <div class="row>">
                                    ...
                                    <div class="content">
                                        <table class="table table-hover table-bordered  table-striped">
                                            ...
                                            <tbody>
                                                @foreach ($terms as $schoolyear_term)
                                                    ...
                                                    @if($schoolyear_term->school_year_id == $current_school_year->id)
                                        ...
                                        <div class="footer">
                                            <div class="chart-legend">
                                                ...
                                                <strong>Term: {{ $current_term->term }}</strong>
                                            </div>
                                            <hr>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <p class="category">
                                            {{@$current_school_year->school_year}} School Year
                                        </p>
                                    </div>
                                    <div class="content">

                                    {!! $school_class_student_chart_current->render() !!}
                                        ...
                                        <div class="footer">
                                           <div class="chart-legend">
                                            ...
                                            <hr>
                                           <div class="stats">
                                                <i class="ti-reload"></i>Term: {{ $current_term->term }} 
